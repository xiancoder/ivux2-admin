    ...
    apiRouter.get('/api/super/roleList', function (req, res) {
        ...
        const data = {
            'list': [
                ...
                { 'id': 2, 'nickname': '小' + pageIndex, 'header': 'http://q1.qlogo.cn/g?b=qq&nk=2546066152&s=100', 'role': 1 },
                { 'id': 3, 'nickname': '小' + pageIndex, 'header': 'http://q1.qlogo.cn/g?b=qq&nk=2546066152&s=100', 'role': 2 },

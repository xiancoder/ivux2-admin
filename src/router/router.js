...
export const mainRouter = {
    ...
    children: [
        ...
        // 修改照片
        {
            path: 'my/picture',
            name: 'modify-picture',
            component: () => import('@/views/my/modify-picture.vue')
        },
        // 私海客户信息
        {
            path: 'private/info',
        ...
        // 通讯录--个人信息详情
        {
            path: 'tel/staff-info',
            name: 'staff-info',
            component: () => import('@/views/tel/staff-info.vue')
        },
        // 流程中心-人事流程-列表
        // {
        ...
        // 流程中心-剩余假期
        {
            path: 'process/unused-holidays',
            name: 'unused-holidays',
            component: () => import('@/views/process/unused-holidays.vue')
        },
        // 流程中心-请假申请
        {
            path: 'process/vacation-apply',
            name: 'vacation-apply',
            component: () => import('@/views/process/vacation-apply.vue')
        },
        {
        ...
        // 流程中心-哺乳假申请
        {
            path: 'process/breastfeed-apply',
            name: 'breastfeed-apply',
            component: () => import('@/views/process/breastfeed-apply.vue')
        },
        // 哺乳假详情
        {
            path: 'process/breastfeed-info',
            name: 'breastfeed-info',
            component: () => import('@/views/process/breastfeed-info.vue')
        },
        // 加班申请
        {
        ...
        // 未打卡申请
        {
            path: 'process/noCheck-apply',
            name: 'noCheck-apply',
            component: () => import('@/views/process/noCheck-apply.vue')
        },
        // 未打卡详情
        {
            path: 'process/noCheck-info',
            name: 'noCheck-info',
            component: () => import('@/views/process/noCheck-info.vue')
        },
        // 外出申请
        {
            path: 'process/outwork-apply',
            name: 'outwork-apply',
            component: () => import('@/views/process/outwork-apply.vue')
        },
        // 外出详情
        {
            path: 'process/outwork-info',
            name: 'outwork-info',
            component: () => import('@/views/process/outwork-info.vue')
        },
        // 出差申请
        {
            path: 'process/busTrip-apply',
            name: 'busTrip-apply',
            component: () => import('@/views/process/busTrip-apply.vue')
        },
        // 出差详情
        {
            path: 'process/busTrip-info',
            name: 'busTrip-info',
            component: () => import('@/views/process/busTrip-info.vue')
        },
        // 商务流程列表
        {
            path: 'business/list',
        ...
        // 合同前置详情
        {
            path: 'business/prepose',
            name: 'prepose-info',
            component: () => import('@/views/business/prepose-info.vue')
        },
        // 广告上线详情
        {
            path: 'business/advertisement',
            name: 'advertisement-info',
            component: () => import('@/views/business/advertisement-info.vue')
        },
        // 变更补充详情
        {
            path: 'business/change',
            name: 'change-info',
            component: () => import('@/views/business/change-info.vue')
        },
        // 商务合同详情
        {
            path: 'business/contract',
            name: 'contract-info',
            component: () => import('@/views/business/contract-info.vue')
        },
        // 框架协议详情
        {
            path: 'business/frame',
            name: 'frame-info',
            component: () => import('@/views/business/frame-info.vue')
        },
        // 发票申请详情
        {
            path: 'business/invoice',
            name: 'invoice-info',
            component: () => import('@/views/business/invoice-info.vue')
        },
        // 广告维护申请详情
        {
            path: 'business/maintain',
            name: 'maintain-info',
            component: () => import('@/views/business/maintain-info.vue')
        },
        // 已发工单--我的工单
        {
            path: 'order/send-list',
            name: 'send-list',
            component: () => import('@/views/order/send-list.vue')
        },
        // 已收工单--我的工单
        {
            path: 'order/receive-list',
            name: 'receive-list',
            component: () => import('@/views/order/receive-list.vue')
        },
        // 草稿箱--我的工单
        {
            path: 'order/drafts-list',
            name: 'drafts-list',
            component: () => import('@/views/order/drafts-list.vue')
        },
        // 已删除--我的工单
        {
            path: 'order/end-list',
            name: 'end-list',
            component: () => import('@/views/order/end-list.vue')
        },
        // 未完结列表--下属工单
        {
            path: 'order/unEndSub-list',
            name: 'unEndSub-list',
            component: () => import('@/views/order/unEndSub-list.vue')
        },
        // 已完结列表--下属工单
        {
            path: 'order/endSub-list',
            name: 'endSub-list',
            component: () => import('@/views/order/endSub-list.vue')
        },
        // 工单详情
        {
        ...
        // 工单发布
        {
            path: 'order/release',
            name: 'order-release',
            component: () => import('@/views/order/order-release.vue')
        },
        // 工单回复
        {
            path: 'order/reply',
            name: 'order-reply',
            component: () => import('@/views/order/order-reply.vue')
        },
        // 组列表
        {
        ...
        // 组添加/编辑
        // {
        //     path: 'order/group-edit',
        //     name: 'group-edit',
        //     component: () => import('@/views/order/group-edit.vue')
        // },
    ]
};

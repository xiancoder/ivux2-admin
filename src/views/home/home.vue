<template>
    <div>
        <x-header :left-options="{showBack: false}" class="header_white"><span class="header_title">云袭移动OA</span></x-header>
        ...
        <div style="margin-top: 10px">
            ...
            <grid :cols="4" :show-lr-borders="false" :show-vertical-dividers="false" class="icon_box">
                <grid-item link="/order/receive-list">
                ...
                <grid-item link="/order/group-list">
                    <img src="../../img/group-manage.png">
                    组查看
                </grid-item>
                <grid-item link="/order/unEndSub-list">
                    <img src="../../img/sub-order.png">
                    下属工单
                </grid-item>
            </grid>
        </div>
        ...
        <div>
            ...
            <grid :cols="4" :show-lr-borders="false" :show-vertical-dividers="false" class="icon_box">
                <div v-if="!childrenName.includes('商务流程')">
                    <!--<grid-item link="/process/unused-holidays">-->
                        <!--<img src="../../img/remain-vacation.png">-->
                        <!--剩余假期-->
                    <!--</grid-item>-->
                    <grid-item link="/process/vacation-apply">
                        <img src="../../img/vacation-apply.png">
                        请假
                    </grid-item>
                    <grid-item link="/process/overtime-apply">
                        <img src="../../img/overtime-apply.png">
                        加班
                    </grid-item>
                    <grid-item link="/process/noCheck-apply">
                        <img src="../../img/uncheck-apply.png">
                        未打卡
                    </grid-item>
                    <grid-item link="/process/outwork-apply">
                        <img src="../../img/outwork-apply.png">
                        外出
                    </grid-item>
                    <grid-item link="/process/busTrip-apply">
                        <img src="../../img/bustrip-apply.png">
                        出差
                    </grid-item>
                    <grid-item link="/process/breastfeed-apply" v-if="gender === 2">
                        <img src="../../img/breastfeed-apply.png">
                        哺乳假
                    </grid-item>
                </div>
        ...
        <div v-if="menuData.includes('客户管理')">
            ...
            <grid :cols="4" :show-lr-borders="false" :show-vertical-dividers="false" class="icon_box">
                <grid-item link="/public/list" v-if="childrenName.includes('公海')">
                    <img src="../../img/public-customer.png">
                    公海
                </grid-item>
                <grid-item link="/private/list" v-if="childrenName.includes('我的客户')">
                    <img src="../../img/my-customer.png">
                    我的客户
                </grid-item>
                <grid-item link="/contact/contactList" v-if="childrenName.includes('联系人')">
                    <img src="../../img/contact-list.png">
                    联系人
                </grid-item>
                <grid-item link="/follow/home" v-if="childrenName.includes('跟进记录')">
                    <img src="../../img/follow-list.png">
                    跟进记录
                </grid-item>
                <grid-item link="/under/list" v-if="childrenName.includes('下属客户')">
                    <img src="../../img/sub-customer.png">
                    下属客户
                </grid-item>
            </grid>
        </div>
        <div v-if="childrenName.includes('商务流程')">
            ...
            <grid :cols="4" :show-lr-borders="false" :show-vertical-dividers="false" class="icon_box">
                <grid-item link="/business/list">
                    <img src="../../img/business-process.png">
                    商务流程
                </grid-item>
                <grid-item link="/charts">
                    <img src="../../img/customer-total.png">
                    客户统计
                </grid-item>
                <grid-item link="/invoice">
                    <img src="../../img/invoice-total.png">
                    发票统计
                </grid-item>
            </grid>
        </div>

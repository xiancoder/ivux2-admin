<template>
    <div class="orderList">
        ...
        <div class="grey_search tab_search">
            <search class="searchInput" style="width: 100%" v-model="request.keyword" :auto-fixed="false"  placeholder="标题、内容、发送人" @on-change="debSearch" @on-submit="submiting"></search>
        </div>
...
export default {
    ...
    methods: {
        ...
        toDetail (id, index) {
            this.$router.push({name: 'order-info', query: {id: id, handle: 1, ending: 0, send: 0, notice: 1}})

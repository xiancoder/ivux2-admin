...
import {Group, TabItem, XTable, Scroller, LoadMore, Divider, Search, debounce} from 'vux'
export default {
    components: {Group, TabItem, XTable, Scroller, LoadMore, Divider, Search, tab, noData},
    data () {
        return {
            names: [

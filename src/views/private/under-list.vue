<template>
    <group class="my-group">
        <x-header @on-click-back="goHome" :left-options="{backText: '', preventGoBack: true}" style="background-color: #0094eb">下属客户</x-header>
        <div class="my-search-form">
            ...
            <search v-model="searchValue" style="width: 90%" class="searchInput"
                    ...
                    @on-clear="serach()"
                    placeholder="请输入客户名称、关键词、负责人"></search>
        </div>
                ...
                <x-table :cell-bordered="false"  >
                    ...
                    <tr @click="toInfo(item.id)" v-show="listData.length>0" v-for="item in listData">
                        ...
                        <td style="text-align: left;padding-left: 8px;line-height: 22px;">
                            ...
                            <div style="color: #666666;font-size: 14px">{{item.cusType}}<span style="margin-left: 20px">负责人：{{item.leader}}</span></div>
                        </td>
...
export default {
    ...
    methods: {
        ...
        getList: function (page_size, v) {
            ...
            this.$get('api/customer/get_list_dept', pa).then((res) => {

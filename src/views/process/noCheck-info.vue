<template>
    <div>
        <x-header @on-click-back="toList" :left-options="{backText: '', preventGoBack: true}" class="header_fix">未打卡详情</x-header>
...
export default {
    ...
    methods: {
        init () { // 初始化 列表
            ...
            this.$get('api/workflow/no_check_info', {
                ...
                this.info.reason = allData.reason; // 未打卡原因
                this.info.createdTimeStr = allData.createdTimeStr; // 未打卡申请时间
                ...
                this.info.clockTimeStr = allData.clockTimeStr; // 未打卡时间
            })
        },
        toList () {
        ...
        agree () {
            this.$post('api/workflow/no_check_pass', {
                mId: this.mId,

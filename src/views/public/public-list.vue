<template>
    <group class="my-group">
        <x-header @on-click-back="goHome" :left-options="{backText: '', preventGoBack: true}" style="background-color: #0094eb">公海</x-header>
...
export default {
    ...
    methods: {
        ...
        toInfo (id) {
            this.$router.push({name: 'public-info', query: {companyId: id}})
        },
        onScrollBottom () {
            if (this.onFetching) {
                // do nothing

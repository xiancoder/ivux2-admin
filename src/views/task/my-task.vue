<template>
    <group class="my-group">
        ...
        <tab active-color="#0094eb" :animate="false">
            <tab-item selected @on-item-click="onItemClick">我发布的</tab-item>
                ...
                <div style="width: 300px">
                    ...
                    <div class="pop-right" v-show="stype === 7">
                        ...
                        <cell title="负责人" primary="content">
                            <div @click="openP(1)" class="select_style">{{personLiableName}}<img src="../../img/arrow.png"/></div>
                        </cell>
                        <cell title="执行人" primary="content">
                            <div @click="openP(2)" class="select_style">{{implementName}}<img src="../../img/arrow.png"/></div>
                        </cell>
                    </div>
...
import {Popup, Checker, XTable, LoadMore, Scroller, Tab, TabItem, Datetime,
    CheckerItem, Group, Cell, Divider, XButton, Search} from 'vux'
export default {
    name: 'my-task',
    ...
    methods: {
        ...
        cons () {}, // 用于关闭输入法弹框
        toInfo (id) {
            this.$router.push({name: 'task-info', query: {taskId: id, role: '1'}})
        },
        openP (mark) {
            this.modalP = true
            this.valueP = ''
        ...
        getList (page_size, v) {
            ...
            this.$get('api/task/myfound', pa).then((res) => {
